...
(function (root, factory) {
  ...
  */
  p5.SpeechRec = function(_lang, _callback) {
    ...
    this.rec.onaudiostart = function() {
      if(that.onAudioStart!=undefined) that.onAudioStart();
    };
    this.rec.onsoundstart= function() {
      if(that.onSoundStart!=undefined) that.onSoundStart();
    };
    this.rec.onspeechstart= function() {
      if(that.onSpeechStart!=undefined) that.onSpeechStart();
    };
    this.rec.onaudioend = function() {
      if(that.onAudioEnd!=undefined) that.onAudioEnd();
    };
    this.rec.onsoundend= function() {
      if(that.onSoundEnd!=undefined) that.onSoundEnd();
    };
    this.rec.onspeechend= function() {
      if(that.onSpeechEnd!=undefined) that.onSpeechEnd();
    };
